...
ROOTS = [
    ...
    r"C:\Cloud\Box\Land\Title Folder\Document Images\Montana\Roosevelt County Images\Books 500+ and Modern",
    r"C:\Cloud\Box\Land\Title Folder\Document Images\Montana\Roosevelt County Images\Misc, LP, Lien, Random Files, and Plats",
    r"C:\Cloud\Box\Land\Title Folder\Document Images\Montana\Roosevelt County Images\Older Docs with only doc numbers",
